...
import 'package:insta_app/screens/user_search_profile_screen.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
     ...
     BlocProvider<AuthCubit>(
      ...
      create: (BuildContext context) => LayoutCubit()..getMyData()..getPosts()  ,
      ...
      child: MaterialApp(
        ...
        home:/*UserSearchProfileScreen()*/   Constants.userId != null ? Responsive(mobScreen:MobileScreen() ,webScreen:WebScreen() )   :  Registercreen() ,
